...
DeepLearningServerPropertiesModel::GetHash() const
{
  ...
  oss << this->GetHostname() << this->GetPort() << this->GetUseSSHTunnel()
      ...
      << this->GetLocalPythonVEnvPath() << this->GetTaskType();
...
{
  m_TaskTypeModel = NewSimpleProperty("TaskType", (int) DeepLearningServerPropertiesModel::TASK_SEGMENTATION);
